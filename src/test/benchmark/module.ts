 ...
 */
export const template = (mail: Array<{sender: string, subject: string, date: string}>) => html`
...
<div class="main-body">
  <div class="main-body-header">
    ...
    <div class="flex"></div>
    <span class="mail-last-range">1–50</span>
  ...
  <div class="main-body-content">
    ...
    <div class="mail-list">
      ${repeat(mail, ({sender, subject, date}) => html`
        <div class="mail-item">
          <mwc-checkbox></mwc-checkbox>
          <mwc-icon-button>star_border</mwc-icon-button>
          <mwc-icon-button>favorite_border</mwc-icon-button>
