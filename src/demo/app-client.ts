...
window.setTimeout(() => {
  ...
  render(
    template({name: 'Hydration', message: 'We have now been hydrated and updated with new data.', items: ['hy', 'dra', 'ted'], prop: 'prop-updated', attr: 'attr-updated', wasUpdated: true}),
    window.document.body
  );
}, 0);
